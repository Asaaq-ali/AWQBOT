...
from plugins.ids import get_mypoint, get_mymessage, get_mycontact
    ...
    if m.new_chat_members:
        ...
        for u in m.new_chat_members:
            ...
            if u.username == get_bot_information()[1]:
                ...
                x = f"""
✪- أهلاً بك عزيزي {u.first_name}

انا بوت اسمي  {botname}
                ...
                if lock_kickbotatban_test(m):
                    ...
                    if lock_lockwelcome_test(m):
                        if get_db_addwelcomegroup(m.chat.id) is None:
                            t = f""" 
• نورتنا يا قمر {u.first_name} 🤍

✪- ممنوع الالفاظ السيئه  ❭ ⚠️
✪- يجب احترام الادمنية
